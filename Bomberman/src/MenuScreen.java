...
public class MenuScreen {
	...
	private boolean overMap1Page = false;
	private boolean overMap2Page = false;
	...
	public void drawMapPage(PApplet drawer) {
		...
		if(startPressed == true) {
			...
			if(drawer.mouseX > 365 && drawer.mouseX < 415 && drawer.mouseY > 600 && drawer.mouseY < 675) {
				...
				changeOverMap1Page(true);
				drawer.stroke(3);
				drawer.strokeWeight(5);
				drawer.ellipse(390, 650, 50,	50);
			}else {
				changeOverMap1Page(false);
			}
			
			if(l1completed) {
				drawer.tint(255);
				drawer.image(bomberFace1, 175, 500);
				
				if(drawer.mouseX > 175 && drawer.mouseX < 225 && drawer.mouseY > 475 && drawer.mouseY < 550) {
					
					overMap2Page = true;
					drawer.stroke(3);
					drawer.strokeWeight(5);
					drawer.ellipse(200, 525, 50,	50);
				}
			...
			if(l2completed) {
				drawer.tint(255);
				drawer.image(bomberFace1, 355, 325);
				
				if(drawer.mouseX > 355 && drawer.mouseX < 405 && drawer.mouseY > 300 && drawer.mouseY < 375) {
					
					overMap3Page = true;
					drawer.stroke(3);
					drawer.strokeWeight(5);
					drawer.ellipse(380, 350, 50,	50);
				}
	...
	public void level2Completed(boolean check) {
		l2completed = check;
	}
