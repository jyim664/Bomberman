				...
				if(player1Bombs.get(0).countDown()) {
					if(!player1Bombs.get(0).getStatus()) {
						...
						for(int i = 0; i < explosionRadius; i++) {
							if(!board.getStatus(player1Bombs.get(0).getXLoc()/50 + explosionRadius - i, player1Bombs.get(0).getYLoc()/50)) {
							...
							if(!board.getStatus(player1Bombs.get(0).getXLoc()/50, player1Bombs.get(0).getYLoc()/50 - explosionRadius + i)) {
						...
						//					if(!board.getStatus(player1Bombs.get(0).getXLoc()/50 - explosionRadius, player1Bombs.get(0).getYLoc()/50)) {
						//						board.addP1Bomb(player1Bombs.get(0).getXLoc()/50 - explosionRadius, player1Bombs.get(0).getYLoc()/50);
						//						player1Bombs.get(0).setLeft(true);
						//						//Left
						//					}
						//
						//					if(!board.getStatus(player1Bombs.get(0).getXLoc()/50, player1Bombs.get(0).getYLoc()/50 - explosionRadius)) {
						//						board.addP1Bomb(player1Bombs.get(0).getXLoc()/50, player1Bombs.get(0).getYLoc()/50 - explosionRadius);
						//						player1Bombs.get(0).setUp(true);
						//							//UP
						//					}
						//
			...
			if(player2Bombs.size() > 0) {
				...
				if(player2Bombs.get(0).countDown()) {
					if(!player2Bombs.get(0).getStatus()) {
						...
						for(int i = 0; i < explosionRadius; i++) {
							if(!board.getStatus(player2Bombs.get(0).getXLoc()/50 + explosionRadius - i, player2Bombs.get(0).getYLoc()/50)) {
							...
							if(!board.getStatus(player2Bombs.get(0).getXLoc()/50, player2Bombs.get(0).getYLoc()/50 - explosionRadius + i)) {
